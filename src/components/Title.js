  ...
  return (
    <div>
      ...
      <div className='col-span-10 pl-16 '>
        <input className="w-1/2  p-2 border-2 border-gray-4 rounded-l-full" type="text" />
        <button className='px-5 py-2 border-2 border-gray-4 rounded-r-full bg-gray-200'> 🔍</button>
      </div>
      <div>
        <img className="h-8"
